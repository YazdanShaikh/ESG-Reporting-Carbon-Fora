                  ...
                  <tr>
                    <td colSpan={7} className="px-6 py-12 text-center">
                      <div className="flex flex-col items-center justify-center space-y-3">
                        <div className="w-16 h-16 bg-gray-300 rounded-xl flex items-center justify-center border border-gray-500/50">
        ...
        return (
          <div className="bg-white border border-gray-500/50 rounded-xl p-8">
            <div className="text-center py-12">
              <div className="w-16 h-16 bg-gray-300 rounded-xl flex items-center justify-center mx-auto mb-4 border border-gray-500/50">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 max-w-2xl mx-auto">
                <div className="bg-gray-300 border border-gray-500/50 rounded-lg p-4">
        ...
        return (
          <div className="bg-white border border-gray-500/50 rounded-xl p-8">
            <div className="text-center py-12">
              ...
              <div className="bg-gray-300 border border-gray-500/50 rounded-lg p-6 max-w-md mx-auto">
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-wrap items-center justify-between gap-4">
        <div className="flex items-center gap-4">
          <div className="flex items-center gap-2">
            ...
            <span className="px-3 py-1 text-sm font-medium bg-gray-300 text-black rounded-lg border border-gray-500/50">
              Draft
            </span>
          </div>
        </div>
        ...
        <div className="flex flex-wrap items-center gap-4">
          <select className="px-4 py-2 text-sm border border-gray-500/50 rounded-lg bg-gray-300 text-black focus:outline-none focus:ring-2 focus:ring-blue-500">
            <option>Campaign Only</option>
          </select>
          <select className="px-4 py-2 text-sm border border-gray-500/50 rounded-lg bg-gray-300 text-black focus:outline-none focus:ring-2 focus:ring-blue-500">
            <option>Last 4 weeks</option>
          </select>
          <div className="flex items-center gap-2 text-sm text-gray-600 bg-gray-300 px-3 py-2 rounded-lg border border-gray-500/50">
            <span>📅</span>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {metricCards.map((metric, index) => {
          ...
          return (
            <div key={index} className="bg-gray-300 border border-gray-500/50 rounded-xl p-6 hover:shadow-lg transition-all duration-200">
      ...
      <div className="bg-gray-300 border border-gray-500/50 rounded-xl p-12 text-center">
